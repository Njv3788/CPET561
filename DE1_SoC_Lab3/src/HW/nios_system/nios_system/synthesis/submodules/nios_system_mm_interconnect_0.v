...
module nios_system_mm_interconnect_0 (
	...
	wire  [94:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> hex_0_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                              // hex_0_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [8:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> hex_0_s1_agent:cp_channel
	...
	wire  [94:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> keys_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                              // keys_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [8:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> keys_s1_agent:cp_channel
	...
	wire  [94:0] hex_0_s1_agent_rp_data;                                                             // hex_0_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [94:0] keys_s1_agent_rp_data;                                                              // keys_s1_agent:rp_data -> router_006:sink_data
