...
set project_name "Arbitration_part2"
...
set_global_assignment -name VHDL_FILE ../../src/HW/Arbitration_part2.vhd
set_global_assignment -name VHDL_FILE ../../src/HW/Arbiter.vhd
