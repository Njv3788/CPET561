...
add_instance avalon_bridge_0 altera_up_avalon_to_external_bus_bridge 18.0
set_instance_parameter_value avalon_bridge_0 {addr_size} {2}
set_instance_parameter_value avalon_bridge_0 {addr_size_multiplier} {Kbytes}
set_instance_parameter_value avalon_bridge_0 {data_size} {16}

add_instance avalon_bridge_1 altera_up_avalon_to_external_bus_bridge 18.0
set_instance_parameter_value avalon_bridge_1 {addr_size} {2}
set_instance_parameter_value avalon_bridge_1 {addr_size_multiplier} {Kbytes}
set_instance_parameter_value avalon_bridge_1 {data_size} {16}
...
add_instance jtag_uart_1 altera_avalon_jtag_uart 18.1
set_instance_parameter_value jtag_uart_1 {allowMultipleConnections} {0}
set_instance_parameter_value jtag_uart_1 {hubInstanceID} {0}
set_instance_parameter_value jtag_uart_1 {readBufferDepth} {64}
set_instance_parameter_value jtag_uart_1 {readIRQThreshold} {8}
set_instance_parameter_value jtag_uart_1 {simInputCharacterStream} {}
set_instance_parameter_value jtag_uart_1 {simInteractiveOptions} {NO_INTERACTIVE_WINDOWS}
set_instance_parameter_value jtag_uart_1 {useRegistersForReadBuffer} {0}
set_instance_parameter_value jtag_uart_1 {useRegistersForWriteBuffer} {0}
set_instance_parameter_value jtag_uart_1 {useRelativePathForSimFile} {0}
set_instance_parameter_value jtag_uart_1 {writeBufferDepth} {64}
set_instance_parameter_value jtag_uart_1 {writeIRQThreshold} {8}
...
add_instance nios2_gen2_1 altera_nios2_gen2 18.1
...
set_instance_parameter_value nios2_gen2_1 {exceptionSlave} {onchip_memory2_1.s1}
...
set_instance_parameter_value nios2_gen2_1 {resetSlave} {onchip_memory2_1.s1}
...
set_instance_parameter_value onchip_memory2_1 {memorySize} {16384.0}
...
set_instance_parameter_value sysid_qsys_0 {id} {589825}

# exported interfaces
add_interface avalon_bridge_0 conduit end
set_interface_property avalon_bridge_0 EXPORT_OF avalon_bridge_0.external_interface
add_interface avalon_bridge_1 conduit end
set_interface_property avalon_bridge_1 EXPORT_OF avalon_bridge_1.external_interface
...
add_connection clk_0.clk avalon_bridge_0.clk

add_connection clk_0.clk avalon_bridge_1.clk

add_connection clk_0.clk jtag_uart_0.clk

add_connection clk_0.clk jtag_uart_1.clk
...
add_connection clk_0.clk_reset avalon_bridge_1.reset

add_connection clk_0.clk_reset jtag_uart_1.reset
...
add_connection nios2_gen2_0.data_master avalon_bridge_0.avalon_slave
set_connection_parameter_value nios2_gen2_0.data_master/avalon_bridge_0.avalon_slave arbitrationPriority {1}
set_connection_parameter_value nios2_gen2_0.data_master/avalon_bridge_0.avalon_slave baseAddress {0x9000}
set_connection_parameter_value nios2_gen2_0.data_master/avalon_bridge_0.avalon_slave defaultConnection {0}
...
set_connection_parameter_value nios2_gen2_0.data_master/jtag_uart_0.avalon_jtag_slave baseAddress {0x9808}
...
set_connection_parameter_value nios2_gen2_0.data_master/sysid_qsys_0.control_slave baseAddress {0x9800}
set_connection_parameter_value nios2_gen2_0.data_master/sysid_qsys_0.control_slave defaultConnection {0}

add_connection nios2_gen2_0.debug_reset_request avalon_bridge_0.reset
...
add_connection nios2_gen2_0.irq avalon_bridge_0.interrupt
set_connection_parameter_value nios2_gen2_0.irq/avalon_bridge_0.interrupt irqNumber {0}
...
add_connection nios2_gen2_1.data_master avalon_bridge_1.avalon_slave
set_connection_parameter_value nios2_gen2_1.data_master/avalon_bridge_1.avalon_slave arbitrationPriority {1}
set_connection_parameter_value nios2_gen2_1.data_master/avalon_bridge_1.avalon_slave baseAddress {0x8000}
set_connection_parameter_value nios2_gen2_1.data_master/avalon_bridge_1.avalon_slave defaultConnection {0}

add_connection nios2_gen2_1.data_master jtag_uart_1.avalon_jtag_slave
set_connection_parameter_value nios2_gen2_1.data_master/jtag_uart_1.avalon_jtag_slave arbitrationPriority {1}
set_connection_parameter_value nios2_gen2_1.data_master/jtag_uart_1.avalon_jtag_slave baseAddress {0x9000}
set_connection_parameter_value nios2_gen2_1.data_master/jtag_uart_1.avalon_jtag_slave defaultConnection {0}
...
set_connection_parameter_value nios2_gen2_1.data_master/nios2_gen2_1.debug_mem_slave baseAddress {0x8800}
...
set_connection_parameter_value nios2_gen2_1.data_master/onchip_memory2_1.s1 baseAddress {0x4000}
set_connection_parameter_value nios2_gen2_1.data_master/onchip_memory2_1.s1 defaultConnection {0}

add_connection nios2_gen2_1.data_master sysid_qsys_0.control_slave
set_connection_parameter_value nios2_gen2_1.data_master/sysid_qsys_0.control_slave arbitrationPriority {1}
set_connection_parameter_value nios2_gen2_1.data_master/sysid_qsys_0.control_slave baseAddress {0x9800}
set_connection_parameter_value nios2_gen2_1.data_master/sysid_qsys_0.control_slave defaultConnection {0}

add_connection nios2_gen2_1.debug_reset_request avalon_bridge_1.reset

add_connection nios2_gen2_1.debug_reset_request jtag_uart_1.reset

add_connection nios2_gen2_1.debug_reset_request nios2_gen2_1.reset

add_connection nios2_gen2_1.debug_reset_request onchip_memory2_1.reset1
...
set_connection_parameter_value nios2_gen2_1.instruction_master/nios2_gen2_1.debug_mem_slave baseAddress {0x8800}
set_connection_parameter_value nios2_gen2_1.instruction_master/nios2_gen2_1.debug_mem_slave defaultConnection {0}

add_connection nios2_gen2_1.instruction_master onchip_memory2_1.s1
set_connection_parameter_value nios2_gen2_1.instruction_master/onchip_memory2_1.s1 arbitrationPriority {1}
set_connection_parameter_value nios2_gen2_1.instruction_master/onchip_memory2_1.s1 baseAddress {0x4000}
set_connection_parameter_value nios2_gen2_1.instruction_master/onchip_memory2_1.s1 defaultConnection {0}

add_connection nios2_gen2_1.irq avalon_bridge_1.interrupt
set_connection_parameter_value nios2_gen2_1.irq/avalon_bridge_1.interrupt irqNumber {0}

add_connection nios2_gen2_1.irq jtag_uart_1.irq
set_connection_parameter_value nios2_gen2_1.irq/jtag_uart_1.irq irqNumber {1}
