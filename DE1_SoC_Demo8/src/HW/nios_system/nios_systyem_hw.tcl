...
add_connection clk_0.clk avalon_bridge.clk

add_connection clk_0.clk jtag_uart_0.clk

add_connection clk_0.clk ledr.clk
...
add_connection nios2_gen2_0.data_master avalon_bridge.avalon_slave
...
add_connection nios2_gen2_0.data_master ledr.s1
...
add_connection nios2_gen2_0.debug_reset_request avalon_bridge.reset

add_connection nios2_gen2_0.debug_reset_request jtag_uart_0.reset

add_connection nios2_gen2_0.debug_reset_request ledr.reset
...
add_connection nios2_gen2_0.irq avalon_bridge.interrupt
